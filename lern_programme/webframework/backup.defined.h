...
int a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, word, string, counter_putintable, column, column_, row, row_, lastrowx, mode, limiter, limiter_, limiter_column/*, puffer_*/, check, zahl, pos, false_var_error, false_var_error_=0, ggv_c;
